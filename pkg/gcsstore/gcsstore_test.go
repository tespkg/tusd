...
import (
	...
	"github.com/tespkg/tusd/pkg/gcsstore"
	"github.com/tespkg/tusd/pkg/handler"
)

// go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/tespkg/tusd/pkg/gcsstore GCSReader,GCSAPI
