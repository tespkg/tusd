...
import (
	...
	tusd "github.com/tespkg/tusd/pkg/handler"
)
...
Please consult the [online documentation](https://godoc.org/github.com/tespkg/tusd/pkg) for more details about tusd's APIs and its sub-packages.
...
* [**s3store**](https://godoc.org/github.com/tespkg/tusd/pkg/s3store): A storage backend using AWS S3
* [**filestore**](https://godoc.org/github.com/tespkg/tusd/pkg/filestore): A storage backend using the local file system
* [**gcsstore**](https://godoc.org/github.com/tespkg/tusd/pkg/gcsstore): A storage backend using Google cloud storage
* [**memorylocker**](https://godoc.org/github.com/tespkg/tusd/pkg/memorylocker): An in-memory locker for handling concurrent uploads
* [**filelocker**](https://godoc.org/github.com/tespkg/tusd/pkg/filelocker): A disk-based locker for handling concurrent uploads
